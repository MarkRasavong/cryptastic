	...
	return (
		<>
			<div>
			 ...
			 sm:p-18 py-10 sm:w-full sm:items-center px-16"
				>
					<div>
				...
				<div className="hidden bg-lightModeWhite dark:bg-darkNonIntComponentBg rounded-lg mt-2 p-4 sm:flex">
			...
			<div className="sm:hidden bg-lightModeWhite dark:bg-darkNonIntComponentBg rounded-lg my-6 p-4 flex sm:px-6 sm:py-12 w-2/4 py-4">
				<a href={profile.links.homepage[0]} target="_blank" rel="noreferrer" className="mr-4">
					<FaLink />
				</a>
				<a href={profile.links.homepage[0]} target="_blank" rel="noreferrer" className="text-xs">
